        ...
        <div id="aa" class="section contact-area">
			...
			?>
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmRegRep" class="contact-form" action="ReparacionesDelete.php" method="post">
                                ...
                                <button type="submit" class="btn"> Eliminar Reparacion!</button>
                            </form>
                        </div>
                    </div>
                </div>
				...
				<?PHP
						...
						if($r>0){
							$SQL="DELETE FROM reparaciones WHERE  id=$idrep;";
							$r = $objAutos->insertAutos($SQL);
					
									if($r == ""){
										echo("Se eliminó la reparacion exitosamente");
									}
									else{
