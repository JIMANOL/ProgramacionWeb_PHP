                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmRegRep" class="contact-form" action="ReparacionesInsert.php" method="post">
								<p>
                                ...
                                <button type="submit" class="btn"> Registrar Reparacion!</button>
                            </form>
                        </div>
                    </div>
                </div>
				...
				<?PHP
						...
						$objAutos = new cls_Autos();
							...
							$sql = "INSERT INTO reparaciones
									VALUES (NULL, '$fecharep', '$horasrep', '$idcoche', '$idmecanico', '$idcliente', 0);";
		
						   $r = $objAutos->insertAutos($sql);
						   if($r == "")
						   echo("Reparacion registrada");
						   else
						   echo("Ocurrió un error al registra la nueva reparacion");
